...
Система реализует архитектуру из курсовой работы (chapter3.tex) и включает:
...
### Мок-модель вместо реальной

Положите обученную модель в `project/models/xgboost_model.pkl`

### Медленная инициализация

При первом запуске система загружает все данные в память для KNN-поиска. Это нормально для ~1 млн записей.
...
Курсовая работа - Система прогнозирования продаж для сети магазинов Rossmann
